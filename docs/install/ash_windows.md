# A Short Hike Manual Installation (Windows)

### Installing or updating the modding tools
1. Download the [Windows version](https://github.com/BrandenEK/AShortHike.ModdingTools/raw/main/win32.zip) of the modding tools
